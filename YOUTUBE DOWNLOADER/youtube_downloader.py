...
p1 = PhotoImage(file='next_coders_logo.png')  # gui logo
root.iconphoto(0, p1)
...
def download():
    ...
    video.download("C:\\Users\\Aman Repuria\\OneDrive\\Desktop")
    # video.download("----------path-----------------------------")
...
label_username = Label(root, text="next_coders", bg="#222222", fg="white")
